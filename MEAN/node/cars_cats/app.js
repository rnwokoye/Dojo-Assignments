...
var server = http.createServer(function (request, response){
    ...
    else if(request.url === '/images/Lamborghini.jpeg'){
        // notice we won't include the utf8 encoding
        fs.readFile('./images/Lamborghini.jpeg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpeg'});
            response.write(contents);
            response.end();
        })
    ...
    else if(request.url === '/images/pussinboots.jpeg'){
        // notice we won't include the utf8 encoding
        fs.readFile('./images/pussinboots.jpeg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpeg'});
            response.write(contents);
            response.end();
        })
